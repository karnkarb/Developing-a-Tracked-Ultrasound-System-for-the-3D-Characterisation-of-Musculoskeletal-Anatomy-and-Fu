...
% set = { 'front_to_back_t1.mat';'front_to_back_t2.mat'; 'front_to_back_t3.mat'; 'front_to_back_t4.mat';...
%     'back_to_front_t1'; 'back_to_front_t2';'back_to_front_t3'};;'tilting_t1.mat'

Set = { 'front_to_back_t2.mat';'b_static_t1.mat'; 'f_static_t1.mat'; 'm_static_t1.mat';...
    'front_to_back_t1.mat';  'front_to_back_t3.mat';...
    'back_to_front_t1.mat';'back_to_front_t2.mat';'back_to_front_t3.mat'};
...
%% Start the semi-sutomated Segmentation
...
for j = 1:size(Set,1)
    ...
    [Marker_Probe_T,Marker_Probe_ref,~,~,Marker_Phantom_T,Marker_Phantom_ref,~,~,...
        tmp_USimage,Quality_Infor{j}] = clean_frame_OPA (data,2,12);
    clear image_no
    ...
    h = gca;
    h.Visible = 'On';
    crop(:,:) = [341,342,208,114;313,415,218,119;329,369,211,113;...
        376,352,205,122;364,401,206,132;322,360,212,115;...
        383,387,204,120;402,357,209,137;335,357,204,125;...
        215,389,247,151];
    ...
    for i = 1:size(image_no,2)
        ...
        elseif (size(slopes, 2) > 40)
            ...
            if best_lines == [0, 0, 0]
                ...
                P1 = [108.53, 24.75, -1.88];
                p1 = [108.53, 24.75, -53.67];
                % coordinates from the phantom geometry for middle row (3)
                H3 = [68.53, 14.75, -6.33];
                h3 = [68.53, 14.75, -50];
                P3 = [108.53, 14.75, -6.33];
                p3 = [108.53, 14.75, -50];
                ...
                Marker_Phantom_tmp = [28.32456218	0	0;-72.31064642	0	0;...
                    0.237355328	40.99000781	0.474211197;-0.237355328	-34.38324685	0.474211197];
                
                %Determine transformation of the markers to Vicon frame
                [ d_Phantom_tmp, Z_Phantom_tmp, tr_Phantom_tmp ] ...
                    = procrustes ( Marker_Phantom_T(:,:,image_no(i))', Marker_Phantom_tmp(:,:),'reflection',false,'scaling',false);
                [ ~, ~, tr_Phantom_reg ] ...
                ...
                if size(XH_total,2)-XH_size >= 2
                    ...
                    elseif thresh4>100
                        ...
                        [FRE_mean_3(tmp),FRE_max_3(tmp),FRE_SD_3(tmp)] = ...
                            FRE_Feedback_2lines(Z_cross_wire_plot_2, XH_ac_3, tr_reg_probe_col, tr_reg_phantom_col);
...
axis equal
error_norm_FRE = error_norm_plot{j,i};
error_norm_FRE_1 = error_norm_plot_1{j,i};
error_norm_FRE_2 = error_norm_plot_2{j,i};
error_norm_FRE_3 = error_norm_plot_3{j,i};
...
n(1) = n_images(1,2)/3;
n(2) = n(1)+(n_images(2,2)-n_images(1,2))/3;
n(3) = n(2)+(n_images(3,2)-n_images(2,2))/3;
n(4) = n(3)+(n_images(4,2)-n_images(3,2))/3;
n(5) = n(4)+(n_images(5,2)-n_images(4,2))/3;
n(6) = n(5)+(n_images(6,2)-n_images(5,2))/3;
n(7) = n(6)+(n_images(7,2)-n_images(6,2))/3;
n(8) = n(7)+(n_images(8,2)-n_images(7,2))/3;
n(9) = n(8)+(n_images(9,2)-n_images(8,2))/3;
...
try_box = [error_norm_FRE;error_norm_FRE_1;error_norm_FRE_2;error_norm_FRE_3];
...
set(h,'Visible','off');
v = nonzeros(Mean_error_plot);
v1= nonzeros(Mean_error_plot_1);
v2= nonzeros(Mean_error_plot_2);
v3= nonzeros(Mean_error_plot_3);
scatter([1;2;3;4],[v(end);v1(end);v2(end);v3(end)],'filled','g')
ylabel('FRE [mm]','FontSize', 17);
set(gca,'XTickLabel',{'Triple-N',' Comb1  ',' Comb2  ',' Comb3  '},'FontSize',17)